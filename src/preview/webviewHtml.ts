 ...
 */
export function generateWebviewHtml(content: string, css: string, vscodeThemeKind: string = 'light'): string {
...
<body style="background:${previewBg};padding:20px;">
  <div id="output" style="width:375px;margin:auto;padding:20px;background:${contentBg};border-radius:8px;">
    ${content}
  </div>
</body>
</html>`;
